...
function DuckIcon(props) {
  ...
  return (
    <motion.svg
      ...
      {...props}>
      <motion.path
        d='M0 11C0 4.925 4.925 0 11 0h122c6.075 0 11 4.925 11 11v122c0 6.075-4.925 11-11 11H11c-6.075 0-11-4.925-11-11V11z'
        fill='#282727'
      ...
      />
      <motion.path
        d='M95.337 59.375c-4.247.637-1.77-8.943 0-13.813.424-.425 4.069 1.063 5.838 1.86 2.548-1.488 4.247-1.86 4.778-1.86 2.123.85 1.769 4.428 1.327 6.11 0 1.275-5.662 4.781-8.493 6.375-.637.425-2.566 1.062-3.45 1.328z'
        fill='#FFF614'
        variants={pathVariants}
        initial='hidden'
        animate='visible'
      />
      <motion.path
        d='M104.678 98.771c-23.566 20.727-60.164 9.565-75.518 1.393-3.213-2.674-11.158-1.114-14.728 0-7.07 9.36 2.945 14.301 8.837 15.601 6.213 6.686 46.685 5.571 66.145 4.178 31.493-.891 35.974-8.728 34.278-12.536 1.285-4.457-12.14-7.614-19.014-8.636z'
        fill='#282727'
        variants={pathVariants}
        initial='hidden'
        animate='visible'
      />
      <ellipse cx={84.455} cy={49.016} rx={2.389} ry={2.391} fill='#282727' />
      <ellipse
        cx={84.19}
        cy={54.063}
        rx={32.91}
        ...
        fillOpacity={0.5}
      />
      <path d='M114 36.913L106 42v-9l8 3.913z' fill='#fff' />
      <ellipse cx={118} cy={31.5} rx={15} ry={9.5} fill='#fff' />
      <circle cx={112} cy={32} r={2} fill='#C4C4C4' />
      <circle cx={118} cy={32} r={2} fill='#C4C4C4' />
      <circle cx={124} cy={32} r={2} fill='#C4C4C4' />
    </motion.svg>
  );
}
